LangHelper uses the Gemini API to assit with language learning! I have been using doulingo for the past few months to learn Norwegian (Hyggelig å møte deg) however I felt 
